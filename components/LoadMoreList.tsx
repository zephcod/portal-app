      ...
      {remaining > 0 && (
        <li>
          <button
            ...
            className="w-full rounded-lg border border-dashed border-edge py-2.5 text-center text-sm font-medium text-muted transition-colors hover:border-gold hover:text-fg"
          >
